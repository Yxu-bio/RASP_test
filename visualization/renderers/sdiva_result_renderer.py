...
class SDivaResultRenderer(BaseResultRenderer):
    def __init__(self):
        self.adapter = ETEAdapter()
        self._sdiva_result = None
        self._tree = None
    ...
    def set_tree(self, tree):
        ...
        if self._sdiva_result is not None:
            self.adapter.apply_diva_result(self._sdiva_result)

    def set_result(self, result):
        self._sdiva_result = result
    ...
    def export_tree_png(self, file_path: str):
        self.adapter.export_png(file_path)

    def export_tree_svg(self, file_path: str):
        self.adapter.export_svg(file_path)

    def export_tree_pdf(self, file_path: str):
